...
<div class="max-w-[85ch]">
	...
	<div class="my-6">
		...
		<ul>
			...
			<li class="pt-2">
				<JumpLink size="lg" href="#metadata-note">Metadata on Sex and Complexion</JumpLink>
			</li>
	...
	<h2 id="introduction" class="mb-4 mt-12">Introduction</h2>
...
<h2 id="methods-glossary" class="mb-4 mt-12">Methods Glossary</h2>
...
<h2 id="tags" class="mb-4 mt-12">Data Provenance Tags</h2>
<p class="mb-12 max-w-[85ch]">
