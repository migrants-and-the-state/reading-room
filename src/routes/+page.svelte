...
<h1 class="mt-20 md:text-5xl">M/S Reading Room v1</h1>
<h2 class="py-1 text-base uppercase tracking-widest md:text-lg">
	Search Prototype for the Study of A-Files
</h2>
